                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('../admin/assets/images/icon/samarinda.png')}}" alt="homepage" class="dark-logo" style="width:40px" />
                            <!-- Light Logo icon -->
                            <img src="{{asset('../admin/assets/images/icon/samarinda.png')}}" alt="homepage" class="light-logo" style="width:40px" />
                        </b>
                        <!--End Logo icon -->
                        <span class="hidden-xs"><span class="font-bold">Siamdakes</span>Admin</span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
